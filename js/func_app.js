...
var ustr1="http://shx.jp/mv/";
//var ustr1="";


function facility_js(){

	var ustr=ustr1+"facility/"
	
	var vna11= ustr+"cafeterias1.mp4";
	var vna12= ustr+"cafeterias2.mp4";

	var pna11= ustr+"cafeterias1.jpg";
	var pna12= ustr+"cafeterias2.jpg";

	
	//*****　注意 ***** ID名前の付け方video01とする。一個しか有効にならない。
	window.onload = function(){
		document.getElementById('video11').src = vna11;
		document.getElementById('video12').src = vna12;
	
    	document.getElementById('video11').poster = pna11;
		document.getElementById('video12').poster = pna12;
...
function eikou_all(){
	...
	$("#eikou_ifr").css("height",zentai_len-170); //全体が移るように広げる
	location.href = "index0.html#index0_top";//先頭に飛ばす
	//カウント
	$(function() {$("<img />").attr("src","http://www.inokuchi-h.hiroshima-c.ed-i.jp/access/Default.aspx?url=eikou_all");}); 
...
function kousin_all(){
	...
	location.href = "index0.html#index0_top";//先頭に飛ばす
	//カウント
	$(function() {$("<img />").attr("src","http://www.inokuchi-h.hiroshima-c.ed-i.jp/access/Default.aspx?url=kousin_all");}); 
...
function osirase_all(){
	...
	location.href = "index0.html#index0_top";//先頭に飛ばす
	//カウント
	$(function() {$("<img />").attr("src","http://www.inokuchi-h.hiroshima-c.ed-i.jp/access/Default.aspx?url=osirase_all");}); 
...
//alert("aa");
	...
	var righ_idou=right_iti;
	if(contents_wid>zentai_wid){
		var righ_idou=contents_wid - zentai_wid+730;
		//alert(righ_idou);
	}else{
		var righ_idou=730-(zentai_wid-contents_wid);
	};
...
function page_change_center_parent(id_name,taget_page,page_height,page_width,p_left,p_top,ftime){
	//alert("aaa");
		...
		setTimeout("page_change_center_parent_do('"+id_name+"','"+taget_page+"',"+page_height+","+page_width+","+p_left+","+p_top+","+ftime+" )", 100);
}
